...
// this file was generated automatically by gerefi tool config_definition_base.jar based on (unknown script) controllers/trigger/trigger_state_primary.txt Sun Jan 07 23:16:15 UTC 2024
...
public class TriggerStatePrimary {
	...
	public static final Field CAMRESYNCCOUNTER = Field.create("CAMRESYNCCOUNTER", 0, FieldType.INT8).setScale(1.0).setBaseOffset(1296);
	public static final Field ALIGNMENTFILL_AT_1 = Field.create("ALIGNMENTFILL_AT_1", 1, FieldType.INT8).setScale(1.0).setBaseOffset(1296);
	public static final Field M_HASSYNCHRONIZEDPHASE = Field.create("M_HASSYNCHRONIZEDPHASE", 4, FieldType.BIT, 0).setBaseOffset(1296);
