...
// this file was generated automatically by gerefi tool config_definition_base-all.jar based on (unknown script) controllers/algo/fuel/fuel_computer.txt Sat Feb 17 23:38:05 UTC 2024
...
public class FuelComputer {
	...
	public static final Field RUNNING_BASEFUEL = Field.create("RUNNING_BASEFUEL", 20, FieldType.INT16).setScale(0.01).setBaseOffset(796);
	public static final Field RUNNING_FUEL = Field.create("RUNNING_FUEL", 22, FieldType.INT16).setScale(0.01).setBaseOffset(796);
	public static final Field AFRTABLEYAXIS = Field.create("AFRTABLEYAXIS", 24, FieldType.INT16).setScale(0.01).setBaseOffset(796);
	public static final Field TARGETLAMBDA = Field.create("TARGETLAMBDA", 26, FieldType.INT16).setScale(1.0E-4).setBaseOffset(796);
	public static final Field TARGETAFR = Field.create("TARGETAFR", 28, FieldType.INT16).setScale(0.001).setBaseOffset(796);
	public static final Field STOICHIOMETRICRATIO = Field.create("STOICHIOMETRICRATIO", 30, FieldType.INT16).setScale(0.001).setBaseOffset(796);
	public static final Field SDTCHARGE_COFF = Field.create("SDTCHARGE_COFF", 32, FieldType.FLOAT).setBaseOffset(796);
	public static final Field SDAIRMASSINONECYLINDER = Field.create("SDAIRMASSINONECYLINDER", 36, FieldType.FLOAT).setBaseOffset(796);
	public static final Field NORMALIZEDCYLINDERFILLING = Field.create("NORMALIZEDCYLINDERFILLING", 40, FieldType.FLOAT).setBaseOffset(796);
	public static final Field BROKENINJECTOR = Field.create("BROKENINJECTOR", 44, FieldType.INT8).setScale(1.0).setBaseOffset(796);
	public static final Field UNUSED88 = Field.create("UNUSED88", 45, FieldType.INT8).setScale(1.0).setBaseOffset(796);
	public static final Field IDEALENGINETORQUE = Field.create("IDEALENGINETORQUE", 46, FieldType.INT16).setScale(1.0).setBaseOffset(796);
	public static final Field INJECTORHWISSUE = Field.create("INJECTORHWISSUE", 48, FieldType.BIT, 0).setBaseOffset(796);
