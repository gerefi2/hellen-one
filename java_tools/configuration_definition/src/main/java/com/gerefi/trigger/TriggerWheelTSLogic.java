...
public class TriggerWheelTSLogic {
    ...
    public void execute(String folder, VariableRegistry variableRegistry) {
        ...
        /*
         * these are templated into gerefi.input file
         * note that TT_TOOTHED_WHEEL is not mentioned in the meta file, we handle it manually right in gerefi.input file
         */
