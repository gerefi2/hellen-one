...
// Keep this list in sync with fuelIgnCutCodeList in gerefi.input!
enum class ClearReason : uint8_t {
	...
	// Keep this list in sync with fuelIgnCutCodeList in gerefi.input!
	// todo: add a code generator between ClearReason and fuelIgnCutCodeList in gerefi.input
};
...
enum class TpsState : uint8_t {
	...
	Redundancy, // 9
	IntermittentPps, // 10
	// keep this list in sync with etbCutCodeList in gerefi.input!
};
