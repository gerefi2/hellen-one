...
#include "pch.h"
#include "com_gerefi_native__EngineLogic.h"
...
JNIEXPORT void JNICALL Java_com_gerefi_native_1_EngineLogic_resetTest
  (JNIEnv *, jclass) {
  printf("[native] resetTest\n");
  ethPtr = nullptr;
}

JNIEXPORT jstring JNICALL Java_com_gerefi_native_1_EngineLogic_getVersion(JNIEnv * env, jclass) {
...
JNIEXPORT jbyteArray JNICALL Java_com_gerefi_native_1_EngineLogic_getConfiguration(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL Java_com_gerefi_native_1_EngineLogic_setConfiguration(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL Java_com_gerefi_native_1_EngineLogic_setSensor
...
JNIEXPORT void JNICALL Java_com_gerefi_native_1_EngineLogic_setEngineType
  (JNIEnv *, jobject, jint engineType) {
    EngineTestHelper* eth = getEth();
    resetConfigurationExt((engine_type_e)engineType);
}

JNIEXPORT void JNICALL Java_com_gerefi_native_1_EngineLogic_invokePeriodicCallback
  (JNIEnv *, jobject) {
...
JNIEXPORT void JNICALL Java_com_gerefi_native_1_EngineLogic_invokeEtbCycle
  (JNIEnv *, jobject) {
  EngineTestHelper* eth = getEth();
...
JNIEXPORT void JNICALL Java_com_gerefi_native_1_EngineLogic_burnRequest
  (JNIEnv *, jobject) {
...
JNIEXPORT void JNICALL Java_com_gerefi_native_1_EngineLogic_initTps
  (JNIEnv *, jobject) {
...
JNIEXPORT void JNICALL Java_com_gerefi_native_1_EngineLogic_initTps2
  (JNIEnv *, jobject) {
	printf("[native] initTps2\n");
}


JNIEXPORT jbyteArray JNICALL Java_com_gerefi_native_1_EngineLogic_getOutputs(JNIEnv * env, jobject instance) {
