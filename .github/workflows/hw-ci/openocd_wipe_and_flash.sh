...
openocd -f "$HW_SCRIPT" -c init -c targets -c "reset halt" -c "flash erase_sector 0 0 last" -c "flash write_image "deliver/gerefi.bin" 0x08000000" -c "reset run" -c "shutdown"
