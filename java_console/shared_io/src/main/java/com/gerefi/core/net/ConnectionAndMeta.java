...
public class ConnectionAndMeta {
    ...
    public static final String BASE_URL_LATEST = "https://gerefi.com/build_server/autoupdate/";
    public static final String BASE_URL_LTS = "https://gerefi.com/build_server/lts/%s/autoupdate/";
