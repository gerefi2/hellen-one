 ...
 * set_etb_duty X
 *
 * http://gerefi.com/forum/viewtopic.php?f=5&t=592
 *
 * @date Dec 7, 2013
...
//	}
  ...
  tcEtbDrop = tcEtbDropTable.getValue(vehicleSpeed, wheelSlip);
...
void doInitElectronicThrottle() {
	...
	// these status flags are consumed by TS see gerefi.input TODO should those be outputs/live data not configuration?!
...
void set18919_AM810_pedal_position_sensor() {
    // todo use setPPSCalibration(0.1, 4.3, 0.1, 1.96); once we have https://github.com/gerefi/gerefi/issues/5056
